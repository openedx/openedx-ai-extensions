...
from openedx_ai_extensions.workflows.processors.xapi.constants import (
...
class BaseOrchestrator:
    ...
    def _emit_workflow_event(self, event_name: str):
        ...
        emit_event(event_name, self.workflow.course_id, {
...
class DirectLLMResponse(BaseOrchestrator):
    ...
    def run(self, input_data):
        ...
        # 3. Emit completed event for one-shot workflow
        self._emit_workflow_event(EVENT_NAME_WORKFLOW_COMPLETED)
