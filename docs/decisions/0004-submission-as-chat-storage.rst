...
* **Performant:** Performance on a large scale, even for conversations that become long.
...
* **Size Constraints:** Submissions are limited at 100KB. Long messages in a conversation will require a chunking strategy.
