...
const Flashcard = ({
    ...
    return (
        <div className="flashcard-scene">
            ...
            >
                {/* Question face */}
                <Card className="flashcard-face flashcard-face--front h-100 rounded-lg" aria-hidden={isFlipped}>
                ...
                {/* Answer face */}
                <Card className="flashcard-face flashcard-face--back bg-light-300 h-100" aria-hidden={!isFlipped}>
                    <Card.Section className="d-flex flex-column align-items-center justify-content-center h-100">
                        <span className="x-small text-uppercase font-weight-bold text-gray-500 mb-2">
